...
public class enemyShip extends Ship {
    ...
    public enemyShip(float movementSpeed, int shield, float width,
                     float height, float xCentre,
                     float yCentre, float laserWidth,
                     float laserHeight, float laserMovementSpeed,
    ...
    private void randomizeDirectionVector() {
        double bearing = MainMenu.random.nextDouble()* 6.283185; // 0 to 2*PI
    ...
    public Laser[] fireLasers() {
        ...
        laser[0] = new Laser(boundingBox.x + boundingBox.width*0.44f,boundingBox.y - laserHeight,
            laserWidth,laserHeight,laserMovementSpeed,laserTextureRegion);
        laser[1] = new Laser(boundingBox.x + boundingBox.width*0.58f,boundingBox.y - laserHeight,
            laserWidth,laserHeight,laserMovementSpeed,laserTextureRegion);
